...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference("MenuItem.count") do
      post menu_items_url, params: { menu_item: { meal_id: @menu_item.meal_id, menu_date: @menu_item.menu_date, restaurant_id: @menu_item.restaurant_id } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { meal_id: @menu_item.meal_id, menu_date: @menu_item.menu_date, restaurant_id: @menu_item.restaurant_id } }
